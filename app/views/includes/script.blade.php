...
<script type="text/javascript" src="{{ asset('js/jquery.flexisel.min.js')}}"></script>
<script type="text/javascript" src="{{ asset('js/jquery.imedica.min.js')}}"></script>
<script type="text/javascript" src="{{ asset('js/custom-imedicajs.min.js')}}"></script>
