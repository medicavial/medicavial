    	...
    	<div class="row">
        	...
        	<div class="col-xs-12 col-sm-6 col-md-3 foot-widget">
                ...
                <address class="foot-address">
                    ...
                    <div class="col-xs-12 no-pad"><i class="icon-phone2 address-icons"></i>01-800 - 3 MEDICA(633422) </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 foot-widget-bottom">
                <p class="col-xs-12 col-md-5 no-pad">2016 MedicaVial | Derechos Reservados | Desarrollado por <a href="mailto:salcala@medicavial.com.mx">Ing. Sergio Alcalá</a></p>
