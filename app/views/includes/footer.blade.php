    	...
    	<div class="row">
        	...
        	<div class="col-xs-12 col-sm-6 col-md-3 foot-widget">
                ...
                <address class="foot-address">
                	<div class="col-xs-12 no-pad"><i class="icon-globe address-icons"></i>MédicaVial (Corporativo) <br />Av. Alvaro Obregon 151 Piso 9 <br />Col. Roma Norte, 06700</div>
                    <div class="col-xs-12 no-pad"><i class="icon-phone2 address-icons"></i><a href="tel:018003633422" class="link-tel gris">01 800 3 MEDICA(633422)</a></div>
                    <div class="col-xs-12 no-pad"><i class="icon-mail address-icons"></i>contacto@medicavial.com.mx</div>
                </address>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 recent-post-foot foot-widget">
            	...
            	<ul>
                    ...
                    <li><a href="images/avisoPrivacidad.pdf" target="_blank">Aviso de privacidad</a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 foot-widget-bottom">
                <p class="col-xs-12 col-md-5 no-pad">&copy; 2016 - {{ date('Y') }} MédicaVial | <small>Desarrollado por Ing. Sergio Alcalá</small> </p>
                <ul class="foot-menu col-xs-12 col-md-7 no-pad">
                    <li><a href="gallery-3-columns.html">Facturación</a></li>
