		...
		<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4 foot-widget">
				  ...
				  <address class="foot-address">
				  	<div class="col-xs-12 no-pad gris"><i class="icon-globe address-icons"></i><a href="https://goo.gl/maps/wGZsQ2juARM2" target="_blank" class="link-tel gris">MédicaVial (Corporativo) <br />Av. Alvaro Obregon 151 Piso 9 <br />Col. Roma Norte, 06700</a></div>
          ...
          <div class="social-wrap">
              <ul>
              <li><a href="https://www.facebook.com/medicavial" target="_blank"><i class="icon-facebook foot-social-icon" id="face-foot" data-toggle="tooltip" data-placement="bottom" title="Facebook"></i></a></li>
              <li><a href="https://twitter.com/MedicaVial" target="_blank"><i class="icon-social-twitter foot-social-icon" id="tweet-foot" data-toggle="tooltip" data-placement="bottom" title="Twitter"></i></a></li>
